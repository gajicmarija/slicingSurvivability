...
name=$(ls)
cd ../code
python3.9 parseResTest.py ${config} ${slices} ${name} # Extract required information from the scavetool csv's
...
# # ###### Plot basic plots ######
python3.9 plotResTest.py ${config} ${slices} ${name} # Plot everything
