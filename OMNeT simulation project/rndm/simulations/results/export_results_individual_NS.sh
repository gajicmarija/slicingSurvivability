...
do
    ...
    ncVP=$(perl -nle'print $& while m{(?<=ncVP )[0-9]+}g' ${sourceFolder}/*-${run_num}.vci)
    ncF=$(perl -nle'print $& while m{(?<=ncF )[0-9]+}g' ${sourceFolder}/*-${run_num}.vci)
    ncLV=$(perl -nle'print $& while m{(?<=ncLV )[0-9]+}g' ${sourceFolder}/*-${run_num}.vci)
    ...
    totalNum=$(($nVID + $nFDO + $nSSH + $nVIP + $nLVD + $ncVP + $ncF + $ncLV))
    ...
    echo -e "\t- $ncVP cVoIP clients"
    echo -e "\t- $ncF cF clients"
    echo -e "\t- $ncLV cLV clients"



    subfolderName="${resultsSubfolder}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}"
    ...
    do
        ...
        opp_scavetool export -f "module=~"*router0.ppp[$sliNum]*" AND name=~"*xPk*" "  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_resAllocLink${sliNum}_vec.csv ${sourceFolder}/*-${run_num}.vec
    ...
    do
        ...
        opp_scavetool export -f "module=~"*hostVID[$cli_num]*"" -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostVID${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
    for cli_num in $(eval echo "{$firstResult..$lastLVD}")
    do
        echo -e "\tExporting for live video client $cli_num:\t\t\c"
        opp_scavetool export -f "module=~"*hostLVD[$cli_num]*""  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostLVD${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
    for cli_num in $(eval echo "{$firstResult..$lastFDO}")
    do
        echo -e "\tExporting for file download client $cli_num:\t\c"
        opp_scavetool export -f "module=~"*hostFDO[$cli_num]*"" -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostFDO${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
    for cli_num in $(eval echo "{$firstResult..$lastSSH}")
    do
        echo -e "\tExporting for SSH client $cli_num:\t\t\c"
        opp_scavetool export -f "module=~"*hostSSH[$cli_num]*""  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostSSH${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
    for cli_num in $(eval echo "{$firstResult..$lastVIP}")
    do
        echo -e "\tExporting for VoIP client $cli_num:\t\t\c"
        opp_scavetool export -f "module=~"*hostVIP[$cli_num]*""  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostVIP${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
    for cli_num in $(eval echo "{$firstResult..$lastcVP}")
    do
        echo -e "\tExporting for cVP client $cli_num:\t\t\c"
        opp_scavetool export -f "module=~"*hostcVP[$cli_num]*""  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostcVP${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
    for cli_num in $(eval echo "{$firstResult..$lastcF}")
    do
        echo -e "\tExporting for cF client $cli_num:\t\t\c"
        opp_scavetool export -f "module=~"*hostcF[$cli_num]*""  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostcF${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
       for cli_num in $(eval echo "{$firstResult..$lastcLV}")
    do
        echo -e "\tExporting for cLV client $cli_num:\t\t\c"
        opp_scavetool export -f "module=~"*hostcLV[$cli_num]*""  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_cVP${ncVP}_cF${ncF}_cLV${ncLV}_hostcLV${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
