...
def plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, dataIdent, folderName, nodeTypesToPlot):
    ...
    averages =[]
    allClients = []
    nodeTypes1=nodeTypes
    nodeSplit1=nodeSplit
    if dataIdent == 'Mos':
        nodeTypes1=['hostLVD', 'hostFDO', 'hostSSH', 'hostVIP','hostcVP','hostcF','hostcLV']
        nodeSplit1 = [37,60,100,350,100,20,18]
    for nodeType,numNodes in zip(nodeTypes1,nodeSplit1):
        if nodeType in nodeTypesToPlot:
            tempValue = []
...
def plotAll(testName, compTestName, nodeTypes, nodeSplit, numSlices, cutoff):
    ...
    plotMeanDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'Mos', 'mos2', ['hostFDO', 'hostSSH','hostcVP','hostcF','hostcLV'])
    globalCounter += 1
    print(testName + ': Plotting MOS CDF...')
    plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'Mos', 'mos2', ['hostFDO', 'hostSSH','hostcVP','hostcF','hostcLV'])
    globalCounter += 1
    if compTestName != '':
        ...
        globalCounter += 1
        plotMeanDataTypeCdfAllAppsComp(testName, compTestName, numCLI, nodeTypes, nodeSplit, 'E2ED', 'endToEndDelay', ['hostVIP','hostcVP'])
        globalCounter += 1
    else:
        globalCounter += 3
    ...
    if 'hostLVD' in nodeTypes:
        ...
        globalCounter += 1
    if 'hostcLV' in nodeTypes:
        print(testName + ': Plotting cLive Video Delay To Live CDF...')
        #plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'DLVD', 'dlvd', ['hostcLV'])
        globalCounter += 1
        #if compTestName != '':
            #plotDataTypeCdfAllAppsComp(testName, compTestName, numCLI, nodeTypes, nodeSplit, 'DLVD', 'dlvd', ['hostcLV'])
        globalCounter += 1
        print(testName + ': Plotting cLive Video Delay To Live CDF...')
        #plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'DAEB', 'daeb', ['hostcLV'])
        globalCounter += 1
        print(testName + ': Plotting cLive Video Estimated Bitrate CDF...')
        #plotEstimatedChosenBitrateLVD(testName, numCLI, nodeTypes, nodeSplit, ['hostcLV'])
        globalCounter += 1
    if 'hostVID' in nodeTypes and 'hostLVD' in nodeTypes:
        print(testName + ': Plotting Video Buffer Length CDF...')
        #plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'DABL', 'dabl', ['hostVID', 'hostLVD','hostcLV'])
        globalCounter += 1
        print(testName + ': Plotting Chosen Video Bitrate CDF...')
        #plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'DAVB', 'davb', ['hostVID', 'hostLVD','hostcLV'])
        globalCounter += 1
        print(testName + ': Plotting Chosen Video Resolution CDF...')
        #plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'DAVR', 'davr', ['hostVID', 'hostLVD','hostcLV'])
        globalCounter += 1
        print(testName + ': Plotting Video MOS CDF...')
        #plotDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'DAMS', 'dams', ['hostVID', 'hostLVD','hostcLV'])
        globalCounter += 1
    if compTestName != '':
    ...
    plotMeanDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'E2ED', 'endToEndDelay', ['hostcVP'])
    globalCounter += 1
    print(testName + ': Plotting Mean RTT CDF...')
    #plotMeanDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'rtt', 'rtt', ['hostVID', 'hostLVD', 'hostFDO', 'hostSSH','hostcF','hostcLV'])
    globalCounter += 1
    ...
    globalCounter += 1
    print(testName + ': Plotting cVoIP Mean End-To-End Delay CDF...')
    plotMeanDataTypeCdfAllApps(testName, numCLI, nodeTypes, nodeSplit, 'E2ED', 'endToEndDelay', ['hostcVP'])
...
if __name__ == "__main__":
    ...
    plotAll(sys.argv[1], '', ['hostVID', 'hostLVD', 'hostFDO', 'hostSSH', 'hostVIP','hostcVP','hostcF','hostcLV'], [numVID, numLVD, numFDO, numSSH, numVIP,numcVP, numcF, numcLV], int(sys.argv[2]), 110)
