...
if __name__ == "__main__":
    ...
    plotAll(sys.argv[1], '', ['hostVID', 'hostLVD', 'hostFDO', 'hostSSH', 'hostVIP','hostcVP','hostcF','hostcLV'], [numVID, numLVD, numFDO, numSSH, numVIP,numcVP, numcF, numcLV], int(sys.argv[2]), 280)
