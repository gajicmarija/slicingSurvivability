...
if __name__ == "__main__":
    ...
    remakeMOSexport(sys.argv[1], numCLI, ['hostVID', 'hostLVD', 'hostFDO', 'hostSSH', 'hostVIP','hostcVP','hostcF','hostcLV'],  [numVID, numLVD, numFDO, numSSH, numVIP,numcVP, numcF, numcLV], ['hostSSH','hostcLV']) #, 'hostVID', 'hostLVD'