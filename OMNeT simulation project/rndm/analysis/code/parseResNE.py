...
def extractAllDataTypeToDF(testName, numCLI, nodeTypes, nodeSplit, nodeTypesToExtract, dataType, dataIdent, folderName):
    ...
    if not os.path.exists(prePath):
        os.makedirs(prePath)
    fname=prePath + makeFullScenarioName(testName, numCLI, nodeTypes, nodeSplit) + '.csv'
    if os.path.isfile(fname):
        dfAll.to_csv(path_or_buf=prePath + makeFullScenarioName(testName, numCLI, nodeTypes, nodeSplit) + '.csv', mode='a')
    else:
